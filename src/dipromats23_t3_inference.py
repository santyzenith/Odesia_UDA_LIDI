...
if __name__ == "__main__":
    dipromatst3_dataset['train'] = dipromatst3_dataset['train'].map(dipromatst3_inference,
                                                                    remove_columns=["text", "formatted_data"],
                                                                    batched=False
                                                                   )
    json_list = [dict(sample) for sample in dipromatst3_dataset['train']]
