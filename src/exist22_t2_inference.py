...
exist22t2_dataset = data_utils.prepare_exist22_t2_test_dataset()
...
if __name__ == "__main__":
    exist22t2_dataset['train'] = exist22t2_dataset['train'].map(exist22t2_inference,
                                                                remove_columns=["text", "formatted_data"],
                                                                batched=False
                                                               )
    json_list = [dict(sample) for sample in exist22t2_dataset['train']]
